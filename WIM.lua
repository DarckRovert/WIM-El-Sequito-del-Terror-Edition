...
-- Funciones de movimiento y posicionamiento de icono movidas a WIM_Icon.lua.
...
-- El resto de funciones de Icono y Menú han sido movidas a WIM_Icon.lua y WIM_Menu.lua para mayor claridad y evitar colisiones.
...
-- Las funciones de barra de accesos directos han sido movidas a WIM_Shortcuts.lua para evitar conflictos.
