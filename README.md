...
Más allá de organizar tus susurros en ventanas, esta edición está conectada al **Traductor Universal v1.0.0 [Omni-Tier]** de pfUI.
...
1.  **Limpieza**: Elimina cualquier versión previa de `WIM` en `AddOns/`.
2.  **Despliegue**: Extrae en `Interface\AddOns\WIM\`.
3.  **Activación**: Al recibir un susurro, WIM se activará. Si tienes el **Traductor v1.0.0** activo en pfUI, el puente se enganchará automáticamente.
